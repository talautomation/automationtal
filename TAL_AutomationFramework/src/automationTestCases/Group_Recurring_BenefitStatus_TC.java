...
public class Group_Recurring_BenefitStatus_TC {
	...
	public void Group_ClaimRecurring() throws Exception {
		...
		List<WebElement> StepAdmitBenefit1 = Claim_Benefit_page.tbl_ChooseNextStep(chiefdriver)
				.findElements(By.cssSelector("tbody > tr"));
		FindRightElement.SelectRightElement(chiefdriver, "Admitted", StepAdmitBenefit1);
		List<WebElement> StepAdmitBenefitReason = Claim_Benefit_page.tbl_ChooseAdmitReason(chiefdriver)
				.findElements(By.cssSelector("tbody > tr"));
		FindRightElement.SelectRightElement(chiefdriver, "Benefit offsets apply", StepAdmitBenefitReason);
		Claim_Benefit_page.btn_Ok(chiefdriver).click();
