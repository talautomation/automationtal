...
public class Group_LivingLSEndToEnd_TC {
	...
	@Test
	public void Group_LivingLSEndToEnd() throws Exception {
		...
		// String sGroupId = ExcelUtils.getCellData(iTestCaseRow,
		// Constant.Col_GroupId);
		...
		Thread.sleep(3000);
		// Input Medical Code
		ClaimIntake_page.txt_DiagnosisCode(chiefdriver).sendKeys("leg");
